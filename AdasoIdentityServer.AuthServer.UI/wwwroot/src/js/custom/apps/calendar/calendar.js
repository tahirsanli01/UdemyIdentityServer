...
var KTAppCalendar = function () {
    ...
    var initCalendarApp = function () {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            locale: 'tr', // Set local --- more info: https://fullcalendar.io/docs/locale
            headerToolbar: {
            ...
            events: [
                {
                    id: uid(),
                    title: '01 Alüminyum Geri Dönüşüm Metal İnşaat Ve Sanayi Ticaret Limited Şirketi',
                    start: YM + '-01',
                    end: YM + '-02',
                    description: 'Yalın Danışmanlığı ve Eğitimi',
                    className: "fc-event-danger fc-event-solid-warning",
                    location: 'Adana Organize Sanayi Bölgesi'
                },
                {
                    id: uid(),
                    title: 'Kıvanç Tekstil Sanayi Ve Ticaret Anonim Şirketi',
                    start: YM + '-14T13:30:00',
                    description: 'Su Kullanılan her Proses İçin İyileştirme Çalışmaları',
                    end: YM + '-14T14:30:00',
                    className: "fc-event-success",
                    location: 'Zeytinli Mah. Turhan Cemal Beriker Bulvarı No: 599 Seyhan, ADANA - TÜRKİYE'
                }
                //{
                //    id: uid(),
                //    title: 'Company Trip',
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "Aktivite Ekle";
