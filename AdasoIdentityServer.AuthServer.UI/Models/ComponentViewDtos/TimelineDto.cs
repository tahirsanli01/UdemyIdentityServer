using static AdasoAdvisor.Models.ComponentViewDtos.TimelineDto.OneWeekDay;
...
namespace AdasoAdvisor.Models.ComponentViewDtos
{
	public class TimelineDto
	{
		...
		{
			this.Title = title;
			this.DayOfWeeks = new OneWeekDay(DateTime.Now).items;
			this.TaskForWeeks = taskForWeeks;
		}
